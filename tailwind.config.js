...
export default {
    ...
    theme: {
        ...
        colors: {
            ...
            'theme-error-350': 'rgb(var(--theme-color-error-350) / <alpha-value>)',
            ...
            'theme-warning-75': 'rgb(var(--theme-color-warning-75) / <alpha-value>)',
            'theme-warning-100': 'rgb(var(--theme-color-warning-100) / <alpha-value>)',
            'theme-warning-150': 'rgb(var(--theme-color-warning-150) / <alpha-value>)',
            ...
            'theme-warning-750': 'rgb(var(--theme-color-warning-750) / <alpha-value>)',
