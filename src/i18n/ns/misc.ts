export default {
    ...
    INFO_TIP: 'Info Tip',
    TIPS: {
        SHORTCUT_TIP_MAC: 'To quickly open the application in your browser, press Shift + Option + A',
        SHORTCUT_TIP_DEFAULT: 'To quickly open the application in your browser, press Shift + Alt + A'
    }
};
