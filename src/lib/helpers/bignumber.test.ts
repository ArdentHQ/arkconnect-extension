...
describe('BigNumber', () => {
    ...
    it('#toString should use the exponential notation above the 35th number', () => {
        expect(BigNumber.make('336536650000000000000000000000000000').toString()).toBe(
            '3.3653665e+35',
        );
    });
    ...
    it('#denominated', () => {
        ...
        expect(BigNumber.make(123_456_789, 5).denominated().toString()).toBe(
            BigNumber.make(1234.567_89).toString(),
        );

        expect(BigNumber.make(123_456_789).denominated(5).toString()).toBe(
            BigNumber.make(1234.567_89).toString(),
        );

        expect(
            BigNumber.make(123_456_789, 5).denominated().isEqualTo(BigNumber.make(1234.567_89)),
        ).toBe(true);

        expect(
            BigNumber.make(123_456_789).denominated(5).isEqualTo(BigNumber.make(1234.567_89)),
        ).toBe(true);
    });
    ...
    it('#toFixed', () => {
        ...
        expect(BigNumber.make(1.234_567_891).toFixed(32)).toBe(
            '1.23456789100000000000000000000000',
        );
