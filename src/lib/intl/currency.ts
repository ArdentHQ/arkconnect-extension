...
// Based on https://github.com/LedgerHQ/ledger-live-common/blob/master/source/currencies/sanitizeValueString.js

const getSeparators = (locale: string): { decimal: number; thousands: number } => {
    const localeNotAvailable =
        (1.2).toLocaleString('en', { style: 'currency', currency: 'USD' }) !== '$1.20';
