...
export class DateTime {
    ...
    public addMilliseconds(value: number): DateTime {
        return DateTime.make(
            this.#instance.add(value, 'millisecond'),
            this.#locale,
            this.#timezone,
        );
    }
    ...
    public subSeconds(value: number): DateTime {
        return DateTime.make(
            this.#instance.subtract(value, 'second'),
            this.#locale,
            this.#timezone,
        );
    }
    ...
    public subMinutes(value: number): DateTime {
        return DateTime.make(
            this.#instance.subtract(value, 'minute'),
            this.#locale,
            this.#timezone,
        );
    }
    ...
    public subQuarters(value: number): DateTime {
        return DateTime.make(
            this.#instance.subtract(value, 'quarter'),
            this.#locale,
            this.#timezone,
        );
    }
    ...
    public format(value: string): string {
        return this.#timezone
            ? this.#instance.tz(this.#timezone).format(value)
    ...
    public toISOString(): string {
        return this.#timezone
            ? this.#instance.tz(this.#timezone).toISOString()
            : this.#instance.toISOString();
    }
    ...
    public toDate(): Date {
        return this.#timezone
            ? this.#instance.tz(this.#timezone).toDate()
            : this.#instance.toDate();
    }
    ...
    #toUTC(value?: DateTimeLike): dayjs.Dayjs {
        if (value instanceof DateTime) {
            return this.#timezone
                ? dayjs.tz(value.valueOf(), this.#timezone)
