...
import { AbiType, decodeFunctionData } from './decode-function-data';

describe('decodeFunctionData', () => {
    it('should decode consensus function data', () => {
        const data =
            '0x1904bb2e000000000000000000000000a0b86991c6218b36c1d19d4a2e9eb0ce3606eb48' as Hex;
    ...
    it('should decode username function data', () => {
        const data =
            '0xce43c032000000000000000000000000a0b86991c6218b36c1d19d4a2e9eb0ce3606eb48' as Hex;
