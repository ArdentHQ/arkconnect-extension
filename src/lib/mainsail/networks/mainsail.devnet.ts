...
const network: Networks.NetworkManifest = {
    ...
    hosts: [
        {
            host:
                import.meta.env.VITE_MAINSAIL_DEVNET_FULL_HOST ||
                'https://testnet.mainsailhq.com/api',
            type: 'full',
        },
        {
            host:
                import.meta.env.VITE_MAINSAIL_DEVNET_TX_HOST ||
                'https://testnet.mainsailhq.com/tx/api',
            type: 'tx',
        },
        {
            host:
        ...
        {
            host:
                import.meta.env.VITE_MAINSAIL_DEVNET_EVM_HOST ||
                'https://testnet.mainsailhq.com/rpc/api',
            type: 'evm',
        },
    ],
    id: 'mainsail.devnet',
