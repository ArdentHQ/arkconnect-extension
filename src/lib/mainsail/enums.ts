export enum FeatureFlag {
    ...
    ClientValidators = 'Client.validators',
    ...
    TransactionValidatorRegistration = 'Transaction.validatorRegistration',
    TransactionValidatorRegistrationLedgerS = 'Transaction.validatorRegistration.ledgerS',
    TransactionValidatorRegistrationLedgerX = 'Transaction.validatorRegistration.ledgerX',
    TransactionValidatorResignation = 'Transaction.validatorResignation',
    TransactionValidatorResignationLedgerS = 'Transaction.validatorResignation.ledgerS',
    TransactionValidatorResignationLedgerX = 'Transaction.validatorResignation.ledgerX',
    TransactionUsernameRegistration = 'Transaction.usernameRegistration',
    TransactionUsernameRegistrationLedgerS = 'Transaction.usernameRegistration.ledgerS',
    TransactionUsernameRegistrationLedgerX = 'Transaction.usernameRegistration.ledgerX',
    TransactionUsernameResignation = 'Transaction.usernameResignation',
    TransactionUsernameResignationLedgerS = 'Transaction.usernameResignation.ledgerS',
    TransactionUsernameResignationLedgerX = 'Transaction.usernameResignation.ledgerX',
