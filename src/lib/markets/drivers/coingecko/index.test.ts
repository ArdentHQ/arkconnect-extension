...
describe('CoinGecko', () => {
    ...
    it('should verify a token', async () => {
        ...
        server.use(
            requestMock('https://api.coingecko.com/api/v3/simple/price', simplePriceFixture),
        );
    ...
    it('should fail to verify a token', async () => {
        server.use(requestMock('https://api.coingecko.com/api/v3/coins/list', coinsListFixture));
        server.use(
            requestMock('https://api.coingecko.com/api/v3/simple/price', {}, { status: 500 }),
        );
    ...
    it('should get historical price data', async () => {
        ...
        server.use(
            requestMock(
                'https://api.coingecko.com/api/v3/coins/ark/market_chart',
                marketChartFixture,
            ),
        );
    ...
    it('should get historical volume data', async () => {
        ...
        server.use(
            requestMock(
                'https://api.coingecko.com/api/v3/coins/ark/market_chart/range',
                marketChartFixture,
            ),
        );
    ...
    it('should get daily average price', async () => {
        server.use(requestMock('https://api.coingecko.com/api/v3/coins/list', coinsListFixture));
        server.use(
            requestMock('https://api.coingecko.com/api/v3/coins/ark/history', historyFixture),
        );
    ...
    it('should get current price', async () => {
        server.use(requestMock('https://api.coingecko.com/api/v3/coins/list', coinsListFixture));
        server.use(
            requestMock('https://api.coingecko.com/api/v3/simple/price', { ark: { usd: 1.3 } }),
        );
