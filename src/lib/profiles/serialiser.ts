    ...
    public toJSON(): IWalletData {
        ...
        return {
            data: {
                ...
                [WalletData.BroadcastedTransactions]: this.#wallet
                    .data()
                    .get(WalletData.BroadcastedTransactions, []),
                ...
                [WalletData.SignedTransactions]: this.#wallet
                    .data()
                    .get(WalletData.SignedTransactions, []),
                [WalletData.PendingMultiSignatures]: this.#wallet
                    .data()
                    .get(WalletData.PendingMultiSignatures, []),
                ...
                [WalletData.EncryptedSigningKey]: this.#wallet
                    .data()
                    .get(WalletData.EncryptedSigningKey),
                [WalletData.EncryptedConfirmKey]: this.#wallet
                    .data()
                    .get(WalletData.EncryptedConfirmKey),
