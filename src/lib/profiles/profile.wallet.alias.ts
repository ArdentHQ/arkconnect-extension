...
import {
    getDefaultAlias,
    getLedgerDefaultAlias,
} from '@/lib/domains/wallet/utils/get-default-alias';
...
export class WalletAliasProvider {
    ...
    public findAliasByAddress(address: string, network?: string): string | undefined {
        ...
        try {
            const useNetworkWalletNames = profile
                .settings()
                .get<boolean>(ProfileSetting.UseNetworkWalletNames);
