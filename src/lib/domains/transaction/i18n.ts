export const translations = {
    ...
    MULTISIGNATURE: {
        ...
        SELECT_PARTICIPANT_DESCRIPTION:
            'Find and select a participant from your contacts and addresses.',
    ...
    PAGE_TRANSACTION_SEND: {
        FORM_STEP: {
            ...
            MULTIPLE_UNAVAILBLE:
                'Multiple Recipient Transactions are not available from Ledger addresses.',
            SCAN: 'Scan',
    ...
    PAGE_VALIDATOR_REGISTRATION: {
        FORM_STEP: {
            ...
            WARNING:
                'The Validator name is permanent and cannot be modified later. It is registered on the network.',
        },
    },
    ...
    RECIPIENTS_HELPTEXT:
        'Selecting Multiple allows you to add multiple recipients in one transaction.',
    ...
    REVOKE_DETAILS:
        'Removed permission for <Token/>  use by <ContractAddress/>  on behalf of <Address/>',
    ...
    TRANSACTION_EXECUTION_ERROR_INSUFFICIENT_GAS:
        'Error encountered during contract execution: Insufficient Gas',
    TRANSACTION_EXECUTION_ERROR_WITH_MESSAGE:
        'Error encountered during contract execution: {{error}}',
    ...
    TRANSACTION_TYPES: {
        ACTIVE_VALIDATORS_COUNT: 'Active Validators Count',
        ...
        GET_ROUNDS_COUNT: 'Get Rounds Count',
        GET_USERNAME: 'Get Username',
        GET_USERNAMES: 'Get Usernames',
        GET_VALIDATOR: 'Get Validator',
        GET_VOTES: 'Get Votes',
        GET_VOTES_COUNT: 'Get Votes Count',
        INITIALIZE: 'Initialize',
        IS_USERNAME_REGISTERED: 'Is Username Registered',
        IS_USERNAME_VALID: 'Is Username Valid',
        IS_VALIDATOR_REGISTERED: 'Is Validator Registered',
        OWNER: 'Owner',
        PAY: 'Multipayment',
        ...
        UPDATE_VOTERS: 'Update Voters',
        UPGRADE_INTERFACE_VERSION: 'Upgrade Interface Version',
        UPGRADE_TO_AND_CALL: 'Upgrade To And Call',
        VERSION: 'Version',
        VOTE: 'Vote',
    },
    ...
    VALIDATION: {
        ...
        INVALID_ADDRESS_OR_NETWORK_MISMATCH:
            'The provided address is invalid or belongs to another network.',
        ...
        NETHASH_NOT_ENABLED:
            'network with nethash <strong>{{nethash}}</strong> is not enabled or available.',
