...
import { openTransport, closeDevices, isLedgerTransportSupported } from "@/lib/contexts/Ledger/transport";
import { useEnvironmentContext } from "@/lib/contexts/Environment";
import { toasts } from "@/lib/services";
import { useLedgerImport } from "@/lib/contexts/Ledger/hooks/import";
import { persistLedgerConnection } from "@/lib/contexts/Ledger/utils/connection";
...
export const useLedgerConnection = () => {
	...
	const connectedToast = useRef<Id | undefined>(undefined);
