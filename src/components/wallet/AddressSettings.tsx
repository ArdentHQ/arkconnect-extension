      ...
      <SafeOutlineOverflowContainer>
        ...
        >
          <SettingsOption
            ...
            onKeyDown={(e) =>
              handleSubmitKeyAction(e, () => navigate(`/edit-address-name/${address.id()}`))
            }
          />
          ...
          <SettingsOption
            ...
            title='Copy Address'
            onClick={() => {
              copy(address.address(), trimAddress(address.address(), 10), ToastPosition.LOWER);
            }}
            onKeyDown={(e) =>
          ...
          <SettingsOption
            ...
            onClick={() => {
              window.open(getExplorerDomain(address.network().isLive(), address.address()));
            }}
            onKeyDown={(e) =>
              handleSubmitKeyAction(e, () =>
                window.open(getExplorerDomain(address.network().isLive(), address.address())),
          ...
          <SettingsOption
            ...
            iconTrailing='arrow-right'
            onKeyDown={(e) =>
              handleSubmitKeyAction(e, () => navigate('/logout', { state: [address.id()] }))
            }
          />
        </FlexContainer>
      </SafeOutlineOverflowContainer>
