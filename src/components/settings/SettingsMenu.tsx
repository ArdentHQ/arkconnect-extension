      ...
      <SafeOutlineOverflowContainer width='100%'>
        <FlexContainer paddingY='8' width='100%' display='flex' flexDirection='column'>
          ...
          <SettingsOption
            ...
            onKeyDown={(e) => handleSubmitKeyAction(e, () => handleNavigation('/local-password'))}
          />
          <SettingsOption
            title='Change Local Currency'
            iconLeading='currency-dollar-circle'
            rightContent={
              <Paragraph $typeset='headline' fontWeight='regular' color='gray' mr='8' size='16'>
                {`${profile.settings().get(Contracts.ProfileSetting.ExchangeCurrency)}`}
              </Paragraph>
            }
            iconTrailing='arrow-right'
            onClick={() => handleNavigation('/local-currency')}
            onKeyDown={(e) => handleSubmitKeyAction(e, () => handleNavigation('/local-currency'))}
          />
          <SettingsOption
          ...
          <SettingsOption
            ...
            onKeyDown={(e) => handleSubmitKeyAction(e, () => handleNavigation('/about'))}
          />
          <SettingsOption
