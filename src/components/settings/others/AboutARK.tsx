        ...
        <SubPageLayout title={t('PAGES.SETTINGS.ABOUT_ARK_CONNECT')}>
            <div className='mb-6 mt-2 flex flex-col items-center gap-4'>
                ...
                <ExternalLink href={`${constants.GITHUB_RELEASES_URL}${version}`} tabIndex={-1}>
                    <Button iconTrailing='link-external' variant='secondaryLink'>
                        <span className='typeset-body transiton-smoothEase font-normal text-theme-secondary-500 hover:text-theme-primary-700 dark:text-theme-secondary-300'>
