...
const SignMessage = ({ formik, goToNextStep, goToPrevStep }: Props) => {
  ...
  const [signedMessage, setSignedMessage] = useState<Services.SignedMessage | undefined>(undefined);
    ...
    <Container>
      ...
      {ledgerWallet && (
        <Container
          border='1px solid'
          borderColor={
            signedMessage ? 'primary' : hasLedgerResponded ? 'rejectedBorder' : 'warning400'
          }
          borderRadius='16'
        >
      ...
      <Paragraph my='24' $typeset='body' fontWeight='regular' color='gray'>
        Ensure that your Ledger is unlocked, connected to your computer, and the ARK app is running.
      </Paragraph>
