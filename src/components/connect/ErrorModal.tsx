    ...
    >
      ...
      >
        ...
        >
          ...
          <Paragraph $typeset='headline' fontWeight='regular' color='gray' textAlign='center'>
            {error ? (
              <span dangerouslySetInnerHTML={{ __html: errorParser(error) }}></span>
            ) : (
              <>
                An unknown error occurred. Try <br /> connecting again. If this error continues{' '}
                <br /> send an email to our support team.
              </>
            )}
          </Paragraph>
        </FlexContainer>
        <FlexContainer flexDirection='column' alignItems='center' width='100%' maxWidth='340px'>
