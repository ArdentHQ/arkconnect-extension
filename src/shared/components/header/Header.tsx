...
export const Header = () => {
  ...
  return (
    <StyledHeader isDark={isDark()} padding='12px 0' withShadow={!isOnboardingPage}>
      <Container className='main-container' paddingLeft='16' paddingRight='16' position='relative'>
        ...
        >
          <FlexContainer
            ...
            marginTop='20'
            width='100%'
            className={`dropdown-body ${showAddressesDropdown ? 'dropdown-transition' : ''}`}
          >
            <AddressesDropdown
        ...
        >
          ...
          >
            <SettingsMenu triggerRef={menuTriggerRef} onClose={() => setOpenSettings(false)} />
          </FlexContainer>
        </FocusTrap>
      </Container>
    </StyledHeader>
